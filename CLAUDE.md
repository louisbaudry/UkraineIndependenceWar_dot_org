...
| A6 — legal-review brief (WP 3.4 §7) | **substantially done 2026-09-15: v0.3, written against French law; two founder decisions outstanding before it is sent** | [`docs/legal/legal-review-brief.md`](docs/legal/legal-review-brief.md) — a brief, not a policy, not a DR-0046 controlled document, not legal advice. Part A = POL-0001 §10's six topics as Q1–Q6 (it does **not** narrow or reinterpret §10); Part B = WP 3.4 §7's five acquisition questions as Q7–Q11, plus Q12 on hosting. **Jurisdiction is France; controller is the founder as a natural person; host is IONOS, Spain** (`DR-pending-establishment-jurisdiction`, approved 2026-09-15 — CDR-P3-42 discharged; CDR-P3-43 and 44 still candidates). v0.3 quotes **LIL Articles 46, 78, 79 and 80** from the CNIL's consolidated text, fetched 2026-09-15 — **Légifrance was 403 behind an anti-bot challenge, so every article must be checked against it before sending**. The drafting surfaced that Art. 46 limits criminal-offence processing to a closed list this project does not obviously sit in, while Art. 80 disapplies Art. 46 for university/literary expression and professional journalism — which **puts POL-0001 §8.3's "archiving primary, expression secondary" ruling genuinely in question**. That is flagged to counsel as a question, never answered here. **§9.5 ruled 2026-09-15: two engagements** — Part A (Q1–Q6) to French data-protection counsel now, Part B (Q7–Q12) held for IP/media counsel later, travelling with the sent brief as context, not instructions. That split has a governance consequence written into CDR-P3-43: **POL-0001 §10 is satisfied by Part A alone**, so Part A's advice is what supersedes DR-0072 and lifts §9's suspension — while Q8/Q9/Q10's acquisition steps (third-party-archive recovery, any `robots.txt` override, named-channel capture) stay unauthorised until Part B is answered, **whatever Part A concludes**. A released §9 is not a licence to run all of Track B. Only §9.4 (project as it is, or as it intends to be) is still open |
...
- **2026-09-15 — the project is established in FRANCE; the controller is
  the founder/principal editor as a natural person (no legal entity); the
  archive server is hosted with IONOS in SPAIN**
  (`DR-pending-establishment-jurisdiction`, approved — option B of three).
