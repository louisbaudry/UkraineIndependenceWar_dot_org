...
- **Three of the seven sanctions authorities in `sources/candidates/` are
  ...
  **`ua-nsdc-sanctions`'s Cloudflare block was cleared 2026-09-22/23** by
  ...
  — see `docs/sources/verification-ua-nsdc-sanctions.md`. **Still not
  registered.** Registering any of the nine now-verified candidates, or
