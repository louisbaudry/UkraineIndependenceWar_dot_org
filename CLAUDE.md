...
- **2026-09-14/15 — the project's establishment jurisdiction is FRANCE, and
  ...
  legal entity (`DR-pending-establishment-jurisdiction`, which amended
  POL-0001 to v1.1 so §10 names it); **confirmed and extended 2026-09-15**
  by `DR-pending-jurisdiction-controller-and-hosting`, which keeps the
