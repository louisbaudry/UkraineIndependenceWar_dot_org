...
- **Two of the seven sanctions authorities in `sources/candidates/` are
  ...
  **One remains a candidate**, blocked rather than merely unverified:
  ...
  it, or re-verifying/re-registering any of the six decided sources, is
  still the founder's act, per source — do not run `register.py --commit`
