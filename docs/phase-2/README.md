...
| [WP 0.6 — Workstream 5: Argumentation Concept Map](working-papers/wp-0.6-ws5-argumentation-concept-map.md) | 0.6 | **CANDIDATE, AI-drafted, awaiting founder approval.** Toulmin, Wigmore, Dung, ASPIC+, AIF, Walton schemes, ACH surveyed; composition: CRMinf grounding + AIF-patterned structure + defeater typing + scheme library + first-class hypothesis sets; no automatic adjudication; 6 candidate DRs (CDR-W5-1…6) |
