...
| [WP 0.5 — Workstream 4: Epistemology & Evidence Concept Map](working-papers/wp-0.5-ws4-epistemology-evidence-concept-map.md) | 0.5 | **CANDIDATE, AI-drafted, awaiting founder approval.** Discipline survey (ICD 203/PHIA, IPCC, legal evidence, source criticism); CRMinf evaluated per DR-0016 (verdict: adopt as grounding + five extensions); six-layer epistemic architecture; epistemic vocabulary v1; two-dimensional uncertainty model; 8 candidate DRs (CDR-W4-1…8) |
