...
| [WP 0.7 — Workstream 6: Sanctions & Export-Control Concept Map](working-papers/wp-0.7-ws6-sanctions-export-controls-concept-map.md) | 0.7 | **CANDIDATE, AI-drafted, awaiting founder approval.** UN/EU/US/UK instrument hierarchies, designation lifecycle, rule-derived effects, export-control decomposition; FtM/OpenSanctions, BODS, GLEIF mapped; 8 candidate DRs (CDR-W6-1…8), incl. the BODS statement pattern for ownership and the territorial-status vocabulary fulfilling DR-0015 |
