...
Determine which established concepts, models, vocabularies, and standards already solve
the problems identified in Phase I — before any ontology, schema, API contract, or
technical stack is frozen.

## Required outputs (per the Phase I record)
...
| [WP 0.4 — Workstream 3: Document Identity & Textual Evidence Concept Map](working-papers/wp-0.4-ws3-document-identity-textual-evidence-concept-map.md) | 0.4 | AI-drafted; reviewed — its seven candidate DRs approved and enacted as DR-0017…0023 (2026-08-11) |
| [WP 0.5 — Workstream 4: Epistemology & Evidence Concept Map](working-papers/wp-0.5-ws4-epistemology-evidence-concept-map.md) | 0.5 | AI-drafted; reviewed — its eight candidate DRs approved and enacted as DR-0024…0031 (2026-08-11) |
| [WP 0.6 — Workstream 5: Argumentation Concept Map](working-papers/wp-0.6-ws5-argumentation-concept-map.md) | 0.6 | AI-drafted; reviewed — its six candidate DRs approved and enacted as DR-0032…0037 (2026-08-11) |
| [WP 0.7 — Workstream 6: Sanctions & Export-Control Concept Map](working-papers/wp-0.7-ws6-sanctions-export-controls-concept-map.md) | 0.7 | AI-drafted; reviewed — its eight candidate DRs approved and enacted as DR-0038…0045 (2026-08-11) |
| [WP 0.8 — Workstream 7: Governance & Versioning Concept Map](working-papers/wp-0.8-ws7-governance-versioning-concept-map.md) | 0.8 | **CANDIDATE, AI-drafted, awaiting founder approval.** ISO 15489 document control, configuration-management baselines, ISO/IEC 11179 + SKOS registry, DCAT/DataCite releases, per-dimension versioning regimes, requirements traceability; 7 candidate DRs (CDR-W7-1…7); final workstream — Phase II consolidation outputs follow |

Acquisition and integrity metadata: [working-papers/PROVENANCE.md](working-papers/PROVENANCE.md).

## Workstream status (research sequence per WP 0.1)
...
Start with: what concepts already exist, what distinctions have mature disciplines
already made, and which standards can faithfully express the requirements discovered
in Phase I. Only then proceed to **Phase III — Conceptual Architecture**.

## Working convention

- Phase II outputs are drafted here as candidate documents. Nothing in this directory
  is canonical until approved by the founder/principal editor (record §78–79, §98).
- Candidate Decision Records are proposals; per §98 they are consolidated and submitted
  as a set for human approval, not mechanically generated one per Phase I question.
