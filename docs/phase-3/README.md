...
| 3 | Identity & entity-resolution workflow — [SPEC-0002 v0.1 drafted](../specifications/SPEC-0002-identity-entity-resolution.md), proposing entity statuses, the match lifecycle, review tiers, and merge/split lineage (CDR-P3-9…11); awaiting founder review | Q-10 |
