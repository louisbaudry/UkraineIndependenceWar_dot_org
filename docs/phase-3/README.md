...
| 10 | ✅ Identifier design — [WP 3.4](working-papers/wp-3.4-identifier-design.md); DR-0087…0091 enacted 2026-09-09 (Q-12 resolved; ARK scheme, minting at publication, five-disposition register, `.vN` qualifiers, ARK-derived namespace). [SPEC-0007 v0.3](../specifications/SPEC-0007-public-identifiers-and-resolution.md) drafted and **implemented** 2026-09-09 (`schema/08-identifiers.sql`, `identifiers/`, Gate 3 minting, tier rules; 64 checks). Candidate pending founder approval; a NAAN must be requested before anything can be minted | Q-12; SPEC-0005 §7 Q1 |
