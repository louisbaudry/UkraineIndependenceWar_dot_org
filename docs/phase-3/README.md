...
| 10 | 🟡 Foundational corpus acquisition strategy — [WP 3.4](working-papers/wp-3.4-foundational-corpus-acquisition.md) deposited 2026-09-08; CDR-P3-31…35 candidate. Founder ruling 2026-09-08: no collection scale-up before the POL-0001 §10 review is recorded; preparatory Track A proceeds under DR-0071. Track A item **A6 drafted 2026-09-15** — [the legal-review brief](../legal/legal-review-brief.md) v0.3, written against French law once the jurisdiction was recorded; CDR-P3-42 discharged, 43 and 44 candidates; two founder decisions outstanding before it is sent | LEGAL-009 / Q-35 before Track B |
